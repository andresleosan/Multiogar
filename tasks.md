...
- [ ] **T4.3**: Validar mensajería bidireccional y adjuntos con reglas y pruebas de abuso. Estado: pendiente de revisión mañana; el bucket privado y `FIREBASE_STORAGE_BUCKET` ya fueron verificados, pero falta completar la prueba real desde Chromium y confirmar el alias principal.
