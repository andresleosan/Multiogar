    ...
    <div>
      ...
      <section className="border-t border-orange-200 bg-brand-warm py-14 dark:border-orange-500/70 dark:bg-slate-950 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ol className="grid gap-8 pt-9 md:grid-cols-3 md:gap-0 md:divide-x md:divide-slate-300 md:dark:divide-slate-700">
            {buyingSteps.map(({ title, description }, index) => (
              <li key={title} className="border-b border-slate-300 pb-7 last:border-b-0 dark:border-slate-700 md:border-b-0 md:px-8 md:first:pl-0 md:last:pr-0">
